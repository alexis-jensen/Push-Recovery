...
bool renderGui = true;
static bool enable_experimental_opencl = true;

static bool gEnableDefaultKeyboardShortcuts = false;
static bool gEnableDefaultMousePicking = false;
...
void OpenGLExampleBrowser::demoSel(int i) {
	selectDemo(i);
}
